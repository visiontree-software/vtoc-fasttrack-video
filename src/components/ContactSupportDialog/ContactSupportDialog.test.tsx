...
describe('the ContactSupportDialog component', () => {
  it('should display Video.isSupported', () => {
    const { getByText } = render(<ContactSupportDialog open={true} onClose={() => {}} />);
  ...
  it('should not display the room type when it is unknown', () => {
    const { queryByText } = render(<ContactSupportDialog open={true} onClose={() => {}} />);
